...
@Component({
  selector: 'app-software-receive-file',
  templateUrl: './software-receive-file.component.html',
  styleUrls: ['./software-receive-file.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SoftwareReceiveFileComponent implements OnInit {
  ...
  constructor(
    ...
    private softwareReceiveFileService: SoftwareReceiveFileService
  ) {
  ...
  public search(reset: boolean = false): void {
    ...
    this.softwareReceiveFileService.fetchData(this.queryInfo.getRawValue()).subscribe((res: any) =>{
